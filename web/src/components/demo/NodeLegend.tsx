...
export function NodeTypeLegend({ graphViewMode }: { graphViewMode: "nodeTypes" | "nodeImportance" | "actualRuntimes" }) {
    ...
    const legendItems = graphViewMode === "nodeImportance" || graphViewMode === "actualRuntimes"
