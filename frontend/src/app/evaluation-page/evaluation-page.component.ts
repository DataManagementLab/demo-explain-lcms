...
export class EvaluationPageComponent implements OnInit {
  ...
  mostImportantNodeEvaluation = signal<
    PartialRecord<ExplainerType, MostImportantNodeEvaluation>
  >({});
  costEvaluations = signal<
    PartialRecord<ExplainerType, TableToScoreEvaluation>
  >({});
  fidelityEvaluation = signal<
    PartialRecord<ExplainerType, TableToScoreEvaluation>
  >({});
  ...
  ngOnInit(): void {
    this.apiService
      ...
      .subscribe((response) =>
        this.costEvaluations.update((value) => ({
          ...value,
          [ExplainerType.gradient]: response,
        })),
      );
    this.apiService
      ...
      .subscribe((response) =>
        this.costEvaluations.update((value) => ({
          ...value,
          [ExplainerType.guidedBackpropagation]: response,
        })),
      );
    ...
    this.apiService
      ...
      .subscribe((response) =>
        this.mostImportantNodeEvaluation.update((value) => ({
          ...value,
          [ExplainerType.gradient]: response,
        })),
      );
    ...
    this.apiService
      ...
      .subscribe((response) =>
        this.fidelityEvaluation.update((value) => ({
          ...value,
          [ExplainerType.gradient]: response,
        })),
      );
